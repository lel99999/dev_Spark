...
#   sparkRH7.vm.box = "generic/rhel7"
    sparkRH7.vm.box = "RH7.5_baserepo"
    #sparkRH7.vm.box = "javier-lopez/rhel-7.4"
    #sparkRH7.vm.box = "xianlin/rhel-7.4"
    sparkRH7.vm.hostname = "flinkRH7"
    sparkRH7.vm.network "private_network", ip: "192.168.60.138"
    sparkRH7.vm.provision "shell", :inline => "sudo echo '192.168.60.138 sparkRH7.local sparkRH7' >> /etc/hosts"
